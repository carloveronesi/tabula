...
/**
 * Aggrega le durate delle entry per tipo e per cliente (solo quelle con
 * clientId). Liste ordinate per minuti decrescenti. Logica pura, indipendente
 * dal periodo: chi chiama passa le entry già filtrate.
 */
